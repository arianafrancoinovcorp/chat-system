<div class="pt-2 pb-6 px-6 bg-white border-b border-gray-200">
    <x-application-logo class="block h-20 w-auto mb-4" />
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-6">
    ...
    <div class="bg-[#9adde6]/10 p-6 rounded-2xl shadow-sm">
        <h2 class="text-xl font-semibold text-[#9adde6] mb-2">Direct Messages</h2>
        <p class="text-gray-600 text-sm">
            Start private conversations with your contacts and stay connected in real time.
        </p>
    </div>
